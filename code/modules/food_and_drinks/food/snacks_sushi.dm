...
/*/obj/item/reagent_containers/food/snacks/sushi_rice
	...
	foodtype = GRAIN
*/ // Lumos Edit - comments out sushi rice for crafting simplicity

// V Small edits, grammatical error fixes, etc. V

/obj/item/reagent_containers/food/snacks/sea_weed
	name = "Sea Weed Sheet"
	desc = "A thin, light salt sheet of plant matter. For use in sushi recipes."
	icon_state = "sea_weed"
