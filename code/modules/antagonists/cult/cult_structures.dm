...
/obj/structure/destructible/cult/talisman
	...
	var/static/image/radial_shell = image(icon = 'icons/obj/antagonists/wizard.dmi', icon_state = "construct-cult")
	var/static/image/radial_unholy_water = image(icon = 'icons/obj/food_and_drinks/drinks.dmi', icon_state = "holyflask")
