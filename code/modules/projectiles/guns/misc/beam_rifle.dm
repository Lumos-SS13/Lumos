...
/obj/item/gun/energy/beam_rifle
	...
	icon = 'icons/obj/weaponry/ranged/energy.dmi'
	icon_state = "esniper"
	item_state = "esniper"
	...
	var/static/image/charged_overlay = image(icon = 'icons/obj/weaponry/ranged/energy.dmi', icon_state = "esniper_charged")
	var/static/image/drained_overlay = image(icon = 'icons/obj/weaponry/ranged/energy.dmi', icon_state = "esniper_empty")
