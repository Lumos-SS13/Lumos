...
/obj/item/gun/attackby(obj/item/I, mob/user, params)
	if(user.a_intent == INTENT_HARM)
		...
		if(bayonet.icon_state in icon_states('icons/obj/weaponry/ranged/bayonets.dmi'))		//Snowflake state?
			state = bayonet.icon_state
		var/icon/bayonet_icons = 'icons/obj/weaponry/ranged/bayonets.dmi'
...
/obj/item/gun/proc/update_gunlight(mob/user = null)
	if(gun_light)
		...
		var/icon2use = 'icons/obj/weaponry/ranged/flashlights.dmi'
		var/state = "flight[gun_light.on? "_on":""]"	//Generic state.
		if(gun_light.icon_state in icon_states('icons/obj/weaponry/ranged/flashlights.dmi'))	//Snowflake state?
