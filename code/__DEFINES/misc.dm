...
GLOBAL_LIST_INIT(pda_reskins, list(PDA_SKIN_CLASSIC = 'icons/obj/items/pda/pda.dmi', PDA_SKIN_ALT = 'icons/obj/items/pda/pda_alt.dmi',
								PDA_SKIN_RUGGED = 'icons/obj/items/pda/pda_rugged.dmi', PDA_SKIN_MODERN = 'icons/obj/items/pda/pda_modern.dmi',
								PDA_SKIN_MINIMAL = 'icons/obj/items/pda/pda_minimal.dmi'))
