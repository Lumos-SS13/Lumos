/turf
	...
	level = 1
	//vis_flags = VIS_INHERIT_PLANE|VIS_INHERIT_ID	//when this be added to vis_contents of something it inherit something.plane and be associatet with something on clicking, // Skyrat edit -- 512 compatibility
