...
GLOBAL_LIST_INIT(metal_recipes, list ( \
	...
	null, \
	new/datum/stack_recipe("metal fireplace", /obj/structure/fireplace/fireplace_metal, 20, time = 40, one_per_turf = TRUE, on_floor = TRUE), \
	null, \
	...
	null, \
	new/datum/stack_recipe("fish tank frame", /obj/structure/fish_tank_base, 10, time = 20, one_per_turf = TRUE, on_floor = TRUE), \
))
...
GLOBAL_LIST_INIT(wood_recipes, list ( \
	...
	null, \
	new/datum/stack_recipe("fireplace", /obj/structure/fireplace, 20, time = 40, one_per_turf = TRUE, on_floor = TRUE), \
	null, \
