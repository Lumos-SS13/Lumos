...
GLOBAL_LIST_INIT(metal_recipes, list ( \
	...
	null, \
	new/datum/stack_recipe("metal fireplace", /obj/structure/fireplace_metal, 20, time = 25, one_per_turf = TRUE, on_floor = TRUE), \
	null, |
...
GLOBAL_LIST_INIT(wood_recipes, list ( \
	...
	null, \
	new/datum/stack_recipe("fireplace", /obj/structure/fireplace, 20, time = 25, one_per_turf = TRUE, on_floor = TRUE), \
	null, \
