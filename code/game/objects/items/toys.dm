...
/obj/item/dualsaber/toy/ComponentInitialize()
	AddComponent(/datum/component/two_handed, force_unwielded=0, force_wielded=1, wieldsound='sound/weapons/saberon.ogg', unwieldsound='sound/weapons/saberoff.ogg')
