...
// Ported from White Sands / Boomer Station - https://github.com/Whitesands13/Whitesands
// Thanks guys!
...
/obj/vehicle/ridden/lawnmower
	...
	var/emagged = FALSE
	var/list/drive_sounds = list('modular_lumos/sound/effects/mowermove1.ogg', 'modular_lumos/sound/effects/mowermove2.ogg')
	var/list/gib_sounds = list('modular_lumos/sound/effects/mowermovesquish.ogg')
	var/driver
...
/obj/vehicle/ridden/lawnmower/Move()
	...
	if(gibbed)
		shake_camera(H, 10, 1)
		if (gib_scream)
			playsound(loc, 'sound/voice/scream/scream_m1.ogg', 100, 1)
		else
