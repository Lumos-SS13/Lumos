...
readonly BASE_PULL_URL="https://api.github.com/repos/Skyrat-SS13/Skyrat13/pulls"
...
if ! git remote | grep Skyrat13 > /dev/null; then
   git remote add Skyrat13 https://github.com/Skyrat-SS13/Skyrat13.git
fi
