...
/datum/species/mush
	femalescreamsounds = list('modular_citadel/sound/voice/scream_f1.ogg', 'modular_citadel/sound/voice/scream_f2.ogg')
	fluff_desc = "Simply refered to as 'myconids', mushroom folk hail from a small planetoid frequently seen as an 'elephant graveyard' for colossal space fauna."
...
/datum/species/jelly
	femalescreamsounds = list('modular_citadel/sound/voice/scream_f1.ogg', 'modular_citadel/sound/voice/scream_f2.ogg')
	fluff_desc = "Slimepeople originate from cross-genetic experimentation with humans and as of now extinct variant of Slime. They are only found within Nanotrasen-owned space, and experience all the same aversions to cold and toxiphilia as their natural counterparts."
