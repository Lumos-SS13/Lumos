...
/datum/martial_art/armstrong/proc/SloppyAnimate(mob/living/carbon/human/A)
	...
	for(var/i in list(NORTH,SOUTH,EAST,WEST,EAST,SOUTH,NORTH,SOUTH,EAST,WEST,EAST,SOUTH))
		if(!A)
			break
		A.setDir(i)
		playsound(A.loc, 'modular_skyrat/sound/weapons/armstrong_punch.ogg', 35, 1, -1)
		sleep(1)
...
/datum/martial_art/armstrong/proc/Buster(var/mob/living/carbon/human/A, var/mob/living/carbon/human/D)
	...
	playsound(D.loc, 'modular_skyrat/sound/weapons/armstrong_zipper.ogg', 100, 1)
...
/datum/martial_art/armstrong/proc/Dropkick(mob/living/carbon/human/A, mob/living/carbon/human/D)
	...
	playsound(D.loc, 'modular_skyrat/sound/weapons/armstrong_punch.ogg', 50, 1, -1)
	A.playsound_local(get_turf(A), 'modular_skyrat/sound/weapons/armstrong_success.ogg', 50, FALSE, pressure_affected = FALSE)
	D.Knockdown(15)
...
/datum/martial_art/armstrong/proc/Surprise(mob/living/carbon/human/A, mob/living/carbon/human/D)
	if(!D.stat && !D.IsKnockdown()) // Blocks easy stunlocking.
		playsound(D.loc, 'modular_skyrat/sound/weapons/armstrong_punch.ogg', 75, 0, -1)
		A.playsound_local(get_turf(A), 'modular_skyrat/sound/weapons/armstrong_success.ogg', 50, FALSE, pressure_affected = FALSE)
		D.Knockdown(50)
		D.emote("scream")
		D.adjustBruteLoss(5)
...
/datum/martial_art/armstrong/proc/do_level_up(mob/living/carbon/human/owner)
	switch(current_level)
		if(2)
			...
			owner.playsound_local(get_turf(owner), 'modular_skyrat/sound/weapons/armstrong_newcombo.ogg', 50, FALSE, pressure_affected = FALSE)
		if(3)
